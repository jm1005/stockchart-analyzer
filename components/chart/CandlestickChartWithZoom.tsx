...
interface CandlestickChartWithZoomProps {
  candles: Candle[];
...
export function CandlestickChartWithZoom({
  candles,
  supportResistance = [],
  patterns = [],
  indicators,
  ...
  const visibleCandles = useMemo(() => {
    ...
    // 스크롤 오프셋 계산 (0 ~ totalCandles - visibleCandleCount)
