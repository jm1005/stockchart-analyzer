...
## Phase 24: react-native-wagmi-charts 도입 및 차트 재구축 (v1.1.0)
- [ ] react-native-wagmi-charts 라이브러리 설치 및 의존성 확인
- [ ] 캔들스틱 차트 컴포넌트 재구축 (WagmiChart 기반)
- [ ] 디자인 개선 (얇은 선, 연한 그리드)
- [ ] GestureHandlerRootView 통합
- [ ] 핀치 줌 및 패닝 기능 (내장)
- [ ] 크로스헤어 및 가격 투다 구현
- [ ] 메인 차트(70%) vs RSI(30%) 레이아웃 분리
- [ ] Reanimated v3 최적화
- [ ] 통합 테스트 및 성능 검증
- [ ] v1.1.0 체크포인트
