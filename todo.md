...
## Phase 23: 그리기 도구 메인 차트 통합 (v1.0.8)
- [ ] DrawingToolsRenderer를 CandlestickChartRefined에 통합
- [ ] 그리기 도구 터치 이벤트 처리 (차트 터치와 분리)
- [ ] 추세선/피보나치/수평선/수직선 SVG 렌더링
- [ ] 그리기 도구 색상 테마 적용 (다크/라이트 모드)
- [ ] 그리기 모드 토글 UI (차트 상단)
- [ ] 그리기 도구 저장/로드 (AsyncStorage)
- [ ] 그리기 도구 삭제 기능
- [ ] 통합 테스트 (기존 61개 + 새로운 테스트)
